...
![supported Minecraft versions: 1.16 | 1.17 | 1.18 | 1.19 | 1.20 | 1.21 | 26.1](https://img.shields.io/badge/support%20for%20MC-1.16%20%7C%201.17%20%7C%201.18%20%7C%201.19%20%7C%201.20%20%7C%201.21%20%7C%2026.1-%2356AD56?style=for-the-badge)

[![curseforge downloads](https://cf.way2muchnoise.eu/full_317514_downloads.svg?badge_style=flat)](https://www.curseforge.com/minecraft/mc-mods/mouse-wheelie)
...
- <kbd>Shift</kbd>: Applies the action to the full stack instead of single items
- <kbd>Ctrl</kbd>: Applies the action to all items of the same type
- <kbd>Alt</kbd>: Drops the item instead of moving it
